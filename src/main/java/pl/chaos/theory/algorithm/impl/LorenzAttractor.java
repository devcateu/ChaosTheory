...
public class LorenzAttractor implements Algorithm {
	...
	public List<ParameterInfo> parameters() {
		...
		parameterInfos.add(new ParameterInfo(new RangeValidator(0, 50), "a", "parameter a (Lorenz default value: 10)"));
                parameterInfos.add(new ParameterInfo(new RangeValidator(0, 50), "b", "parameter b (Lorenz default value: 2.26)"));
		parameterInfos.add(new ParameterInfo(new RangeValidator(0, 50), "c", "parameter c (Lorenz default value: 28)"));
